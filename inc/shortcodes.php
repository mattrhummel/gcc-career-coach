...
function gcc_wp_2018_ccwidget_shortcodes() {
    ...
    //[data_center_tech_ccwidget]
    add_shortcode( 'data_center_tech_ccwidget', 'data_center_tech_ccwidget_shortcode');
    ...
    add_shortcode( 'et_csc_ccwidget', 'et_csc_ccwidget_shortcode');
     //[ecadd_csc_ccwidget]
    add_shortcode( 'ecadd_csc_ccwidget', 'ecadd_csc_ccwidget_shortcode');
